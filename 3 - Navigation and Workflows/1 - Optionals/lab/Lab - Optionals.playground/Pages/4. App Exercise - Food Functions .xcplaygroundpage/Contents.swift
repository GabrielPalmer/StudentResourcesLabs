...
func getMealFromLog(mealType: String) -> Meal? {
    
    for meal in meals {
        if meal.key == mealType {
            return meal.value
        }
    }
    print("Meal \"\(mealType)\" has not been logged yet.")
    return nil
}

print(getMealFromLog(mealType: "Dinner"))
print(getMealFromLog(mealType: "Breakfast"))
/*:
 ...
 */
func isSaved(mealLog: String) -> [String : Any] {
