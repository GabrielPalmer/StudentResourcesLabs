...
//foo only exists in the scope of the loop
/*:
...
//x is outside of just the scope of the loop
//x is declared on a global scope and modified in the for loop
/*:
...
greeting(greeting: "Hey ugly!", name: "Elmo")
greeting(greeting: nil, name: "Bobert")
/*:
