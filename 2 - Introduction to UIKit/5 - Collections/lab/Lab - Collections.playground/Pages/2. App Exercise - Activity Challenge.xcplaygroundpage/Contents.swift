 ...
 */
var runningChallenges: [String] = ["Walk 3 miles a day", "Run 5 times a week"]
var walkingChallenges: [String] = ["Walk for 1 hour straight", "Walk backwards all day"]
 ...
 */
var challenges: [[String]] = [runningChallenges, walkingChallenges]
...
if activeChallenges.isEmpty {
    print("Pick a new challenge.")
} else if activeChallenges.count == 1 {
    print("You have chosen challenge \(activeChallenges[0]).")
} else {
    print("You have chose multiple challenges.")
}
