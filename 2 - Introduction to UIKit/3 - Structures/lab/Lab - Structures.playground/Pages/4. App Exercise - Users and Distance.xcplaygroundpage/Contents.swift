 ...
 */
var gabe = User(name: "Gabriel Palmer", age: 17, height: 71.0, weight: 135.0, activityLevel: 4)

print(gabe.name)
print(gabe.age)
print(gabe.height)
print(gabe.weight)
print(gabe.activityLevel)
 ...
 */
var mile = Distance(meters: 1600.0)
 ...
 */
var kilometer = Distance(meters: 1000.0)
